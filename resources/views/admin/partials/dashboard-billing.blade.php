...
// - Author: Gus Kazem
// - https://Gusgraph.com
// - File Path: resources/views/admin/partials/dashboard-billing.blade.php
// ======================================================
?>
<section class="dashboard-card dashboard-card--billing">
    <header class="dashboard-card__header">
        <div class="dashboard-card__heading">
            @include('partials.ui.icon', ['icon' => 'fa-solid fa-receipt', 'tone' => 'emerald', 'size' => 'lg'])
            <div>
                <p class="dashboard-card__eyebrow">Billing and subscriptions</p>
